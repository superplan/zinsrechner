...
#        werte = (restSchuld, kostenSZB, kostenTotal, dauerTotal)
        self.view.labelRestschuld.setText  (locale.format('%.2f', werte[0], True))
        self.view.labelZKosten.setText     (locale.format('%.2f', werte[1], True))
        self.view.labelZKostenTotal.setText(locale.format('%.2f', werte[2], True))
